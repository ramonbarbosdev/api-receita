...
export namespace Prisma {
  ...
  */
    ...
    model: {
      Receita: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.ReceitaFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.ReceitaAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export interface ReceitaDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Receitas that matches the filter.
     * @param {ReceitaFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const receita = await prisma.receita.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: ReceitaFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Receita.
     * @param {ReceitaAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const receita = await prisma.receita.aggregateRaw({
     *   pipeline: [
     ...
     * })
     */
    aggregateRaw(args?: ReceitaAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
   ...
   * Receita findRaw
   */
  export type ReceitaFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  /**
   * Receita aggregateRaw
   */
  export type ReceitaAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
